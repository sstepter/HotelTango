...
namespace HotelTango.Data.Migrations
{
    ...
    [Migration("20221107203050_addreservation")]
            ...
            modelBuilder.Entity("HotelTango.Models.Reservation", b =>
                {
                    ...
                    b.Property<string>("WIFI_ID")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("11/7/2022_CAST(ROOMID AS VARCHAR(500))+ CAST(ID AS VARCHAR(500))+ CAST(CustomerID AS VARCHAR(500))");
