...
namespace HotelTango.Data.Migrations
{
    ...
    [Migration("20221107204037_addreservation")]
            ...
            modelBuilder.Entity("HotelTango.Models.Reservation", b =>
                {
                    ...
                    b.Property<string>("WIFI_ID")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("REPLACE(CONVERT(varchar, SYSDATETIME(), 11), '/', '') + '_' + CAST(ROOMID AS VARCHAR(500)) + '_' + CAST(ID AS VARCHAR(500)) + '_' + CAST(CustomerID AS VARCHAR(500)), ");
